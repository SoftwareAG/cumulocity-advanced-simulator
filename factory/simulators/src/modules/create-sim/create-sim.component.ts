...
unit: string;
  ...
  template = { "fragment": null, "series": null, "minValue": null, "maxValue": null,
   "steps": null, "unit": null, "tempType": "measurement" };
  ...
  ngOnInit() {
    ...
    this.inventory.detail(this.simulatorId).then(result=> {this.mo = result.data;
      console.log(this.mo);});
